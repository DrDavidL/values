...
with st.expander("About this App"):
    ...
    st.info("If you have an optional password, AI versions of your value statements are re-phrased using the [Gemini Language Model](https://aistudio.google.com/): ")
